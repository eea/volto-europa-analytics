            ...
            if (x(aA)) {
              ...
              if (av[aA]) {
                ...
                var aC =
                  "The method '" +
                  aA +
                  '\' was not found in "Matomo_paq" variable.  Please have a look at the Matomo tracker documentation: https://developer.matomo.org/api-reference/tracking-javascript';
                ao(aC);
                if (!aB) {
            ...
            if (at === au) {
              ...
              if (
                ...
                ao(
                  'The method ' +
                    au +
                    ' is registered more than once in "Matomo_paq" variable. Only the last call has an effect. Please have a look at the multiple Matomo trackers documentation: https://developer.matomo.org/guides/tracking-javascript-guide#multiple-piwik-trackers',
                );
              }
              az[au]++;
            }
